...
NS_LOG_COMPONENT_DEFINE ("TipcSignalLinkRxBuffer");

NS_OBJECT_ENSURE_REGISTERED (TipcSignalLinkRxBuffer);

TypeId
TipcSignalLinkRxBuffer::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::TipcSignalLinkRxBuffer")
    .SetParent<Object> ()
    .SetGroupName ("Tipc")
    .AddConstructor<TipcSignalLinkRxBuffer> ()
    .AddTraceSource ("NextRxSequence",
                     "Next sequence number expected (RCV.NXT)",
                     MakeTraceSourceAccessor (&TipcSignalLinkRxBuffer::m_nextRxSeq),
 ...
 */
TipcSignalLinkRxBuffer::TipcSignalLinkRxBuffer (uint32_t n)
  : m_nextRxSeq (n), m_gotFin (false), m_size (0), m_maxBuffer (32768), m_availBytes (0)
{
}

TipcSignalLinkRxBuffer::~TipcSignalLinkRxBuffer ()
{
}

SequenceNumber32
TipcSignalLinkRxBuffer::NextRxSequence (void) const
{
  return m_nextRxSeq;
}

void
TipcSignalLinkRxBuffer::SetNextRxSequence (const SequenceNumber32& s)
{
  m_nextRxSeq = s;
}

uint32_t
TipcSignalLinkRxBuffer::MaxBufferSize (void) const
{
  return m_maxBuffer;
}

void
TipcSignalLinkRxBuffer::SetMaxBufferSize (uint32_t s)
{
  m_maxBuffer = s;
}

uint32_t
TipcSignalLinkRxBuffer::Size (void) const
{
  return m_size;
}

uint32_t
TipcSignalLinkRxBuffer::Available () const
{
  return m_availBytes;
}

void
TipcSignalLinkRxBuffer::IncNextRxSequence ()
{
...
SequenceNumber32
TipcSignalLinkRxBuffer::MaxRxSequence (void) const
{
  if (m_gotFin)
...
void
TipcSignalLinkRxBuffer::SetFinSequence (const SequenceNumber32& s)
{
  NS_LOG_FUNCTION (this);
...
bool
TipcSignalLinkRxBuffer::Finished (void)
{
  return (m_gotFin && m_finSeq < m_nextRxSeq);
}

bool
TipcSignalLinkRxBuffer::Add (Ptr<Packet> p, TipcSignalLinkHeader const& tcph)
{
...
uint32_t
TipcSignalLinkRxBuffer::GetSackListSize () const
{
  NS_LOG_FUNCTION (this);
...
void
TipcSignalLinkRxBuffer::UpdateSackList (const SequenceNumber32 &head, const SequenceNumber32 &tail)
{
...
void
TipcSignalLinkRxBuffer::ClearSackList (const SequenceNumber32 &seq)
{
...
TipcSignalLinkRxBuffer::GetSackList () const
{
  return m_sackList;
}

Ptr<Packet>
TipcSignalLinkRxBuffer::Extract (uint32_t maxSize)
{
