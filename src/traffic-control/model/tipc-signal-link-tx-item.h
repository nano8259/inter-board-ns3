 ...
 *
 */
#ifndef TIPC_SIGNAL_LINK_TX_ITEM_H
#define TIPC_SIGNAL_LINK_TX_ITEM_H
...
private:
  ...
  friend class TipcSignalLinkTxBuffer;
...
#endif /* TIPC_SIGNAL_LINK_TX_ITEM_H */
