...
#ifndef TIPC_SIGNAL_LINK_RX_BUFFER_H
#define TIPC_SIGNAL_LINK_RX_BUFFER_H
...
#include "ns3/ptr.h"
#include "ns3/tipc-signal-link-header.h"
 ...
 * \see UpdateSackList
 */
class TipcSignalLinkRxBuffer : public Object
{
public:
  /**
   ...
   */
  TipcSignalLinkRxBuffer (uint32_t n = 0);
  virtual ~TipcSignalLinkRxBuffer ();
  ...
  /**
   * \brief Get the lowest sequence number that this TipcSignalLinkRxBuffer cannot accept
   * \returns the lowest sequence number that this TipcSignalLinkRxBuffer cannot accept
   */
   ...
   */
  bool Add (Ptr<Packet> p, TipcSignalLinkHeader const& tcph);
...
#endif /* TIPC_SIGNAL_LINK_RX_BUFFER_H */
